	...
	var domoPanel = function() {
		// Check if the element exists before initializing PerfectScrollbar
		if (jQuery('.dz-demo-content').length > 0) {
			try {
				const ps = new PerfectScrollbar('.dz-demo-content');
			} catch (error) {
				console.error("Error initializing PerfectScrollbar in domoPanel:", error);
			}
		} else {
			console.warn("Element '.dz-demo-content' not found for PerfectScrollbar initialization.");
		}
